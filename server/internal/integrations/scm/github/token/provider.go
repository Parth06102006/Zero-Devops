// Package token creates GitHub App installation access tokens.
package token
...
// NewInstallationTokenProvider creates a token provider from GitHub App credentials.
func NewInstallationTokenProvider(appID, privateKeyPath string) domain.InstallationTokenProvider {
